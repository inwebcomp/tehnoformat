...
class ImageColors {
	...
	private function getPercentageOfColors(){
		...
		asort($coinciditions);
		$coinciditions = array_reverse($coinciditions);
	...
	public function getColor($hex) {
		...
		$color = $this->getClosestColor( $rgb[0], $rgb[1], $rgb[2] );
	...
	private function getPalette() {
		...
		$str = '["#660000", "#cc0000", "#ea4c88", "#993399", "#0066cc", "#66cccc", "#669900", "#666600", "#ffff00", "#ffcc33", "#ff9900", "#ff6600", "#cc6633", "#663300", "#000000", "#cccccc", "#ffffff", "#E7D8B1"]';
