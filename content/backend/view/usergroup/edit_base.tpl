        ...
        <div class="panel-body">
            ...
            <form role="form" rel="{%oc%}" action="{%controllerName%}/save" class="ajax-form-request form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group{%ifset .err_name%} has-error{%endif%}">
                    ...
                    <div class="col-md-6">
                        <select name="params[name]" class="form-control" id="name">
                            <option {%if name == "user"%}selected{%endif%} value="user">user</option>
                            <option {%if name == "moder"%}selected{%endif%} value="moder">moder</option>
                            <option {%if name == "admin"%}selected{%endif%} value="admin">admin</option>
                            <option {%if name == "developer"%}selected{%endif%} value="developer">developer</option>
                            <option {%if name == "guest"%}selected{%endif%} value="guest">guest</option>                    
                        </select>
