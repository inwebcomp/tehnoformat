	...
	<div class="panel-body">
		...
		<form role="form" rel="{%oc%}" action="{%controllerName%}/save" class="ajax-form-request form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group{%ifset .err_description%} has-error{%endif%}">
                <label class="control-label col-md-2" for="description">{%lang Текст%}:</label>
                <div class="col-md-6">
                    <textarea name="params[description]" class="form-control {%ifset use_editor%} text-editor{%endif%}">{%.description%}</textarea>
