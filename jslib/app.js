...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_scroll_into_view__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Popup__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Popup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_Popup__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__forms_ContactForm__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__forms_ContactForm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__forms_ContactForm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_qs__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_qs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_sticky_sidebar__ = __webpack_require__(48);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__webpack_require__(38));
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: {
        Popup: __WEBPACK_IMPORTED_MODULE_4__components_Popup___default.a,
        ContactForm: __WEBPACK_IMPORTED_MODULE_5__forms_ContactForm___default.a
    },
    ...
    methods: {
        showPopup: function showPopup(name) {
            ...
            if (this.$refs[name] == undefined) return console.error("[Vue/Popup]: Popup '" + name + "' not found");
        ...
        scrollToBlock: function scrollToBlock(e, id) {
            ...
            if (window.location.pathname == '/' || window.location.pathname == '/ru' || window.location.pathname == '/ro') {
                ...
                __WEBPACK_IMPORTED_MODULE_3_scroll_into_view___default()(el, {
                    time: 350
                });
        ...
        saveTextpage: function saveTextpage(ID) {
            var value = $("#editor").froalaEditor('html.get');

            if (!value && !confirm("Сохранится пустое значение. Продолжить?")) return;
            ...
            self.axios.request({
                ...
                data: __WEBPACK_IMPORTED_MODULE_6_qs___default.a.stringify({ ID: ID, value: value })
            }).then(function () {
        ...
        saveCategory: function saveCategory(ID) {
            var value = $("#editor").froalaEditor('html.get');
            var value2 = $("#editor2").froalaEditor('html.get');
            ...
            self.axios.request({
                ...
                data: __WEBPACK_IMPORTED_MODULE_6_qs___default.a.stringify({ ID: ID, value: value, value2: value2 })
            }).then(function () {
                self.saveButtonText = "Данные сохранены";
                self.textChanged = false;
        ...
        calculateFloatingHeader: function calculateFloatingHeader() {
        ...
        calculateFloatingButton: function calculateFloatingButton() {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a8fbc54a", Component.options)
  } else {
    hotAPI.reload("data-v-a8fbc54a", Component.options)
  }
...
var render = function() {
  ...
  return _c(
    "transition",
    { attrs: { name: _vm.transition, duration: _vm.duration } },
    [
      _c(
        "div",
        {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a8fbc54a", module.exports)
  }
}
...
Component.options.__file = "assets/js/forms/ContactForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c3b78ca8", Component.options)
  } else {
    hotAPI.reload("data-v-c3b78ca8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Form__ = __webpack_require__(44);



/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0__components_Form__["a" /* default */]],
    ...
    methods: {
        submit: function submit() {
            ...
            if (!self.checkLoading()) return false;
            ...
            this.axios.post('/json/frontend/' + App.language + '/forms/contact', Object.assign({}, self.form, {
        ...
        verify: function verify() {
            var onlyWhenError = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

            if (onlyWhenError && this.error == false) return;
            ...
            if (this.form.phone == '' && this.form.email == '') this.errors.phone = true;
